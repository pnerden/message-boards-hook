...
if ((category == null)) {
	backURLLabel = LanguageUtil.format(pageContext, "back-to-x", new Object[] {"new-category"});
} else {
	backURLLabel = LanguageUtil.format(pageContext, "back-to-x", new Object[] {category.getName()});
}
%>
