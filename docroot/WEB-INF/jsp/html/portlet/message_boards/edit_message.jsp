...
if ((message == null)) {
	backURLLabel = LanguageUtil.format(pageContext, "back-to-x", new Object[] {"new-message"});
} else {
	backURLLabel = LanguageUtil.format(pageContext, "back-to-x", new Object[] {message.getSubject()});
}

%>
<div class="message-buttons message-buttons-top">
...
<div class="message-buttons message-buttons-bottom">
	<aui:button href="<%= redirect %>" cssClass="back-button" value="<%= backURLLabel %>" last="true" />
</div>
